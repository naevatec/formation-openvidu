...
function getToken(callback) {
    ///HERE SEEMS TO CONTINUE WITHOUT callBack check where it's lost
	httpPostRequest(
		'api-ov/get-token',
		{},
...
function appendUserData(videoElement, connection) {
	...
	addClickListener(videoElement,  serverData);
}
...
function addClickListener(videoElement, serverData) {
